...
Allocated the first small chunk on the heap at 0x559b82dab260
stack_buffer_1 at 0x7fff5e28bb00
stack_buffer_2 at 0x7fff5e28bae0
...
Allocated the large chunk on the heap at 0x559b82dab2d0
Freeing the chunk 0x559b82dab260, it will be inserted in the unsorted bin
...
This means that the chunk 0x559b82dab260 will be inserted in front of the SmallBin
The chunk that can't be handled by the unsorted bin, nor the SmallBin has been allocated to 0x559b82dab6c0
...
The fwd pointer of stack_buffer_2 has changed after the last malloc to 0x7fff5e28bb00

p4 is 0x559b82dabb80 and should be on the stack!
